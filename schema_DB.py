...
class Author(EmbeddedDocument):
    ...
    author_email = EmailField(min_length=1,max_length=100, required=True)
...
class DocumentCase(Document):
    ...
    incidentDate = StringField(min_length=1, required=True, format='YYYY-MM-DD')
    creationDate = StringField(min_length=1, required=True, format='YYYY-MM-DD')
